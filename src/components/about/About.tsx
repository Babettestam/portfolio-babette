      ...
      <div className="col-start-2 text-center">
        <SlideIn>
          ...
          <p className="max-w-[500px] text-justify mx-auto my-10">
            ...
            skills there. Not only as an employee I grew in front-end
            development, but also with my own company I kept growing my skills
            in full-stack by making websites for others.{" "}
          </p>
        </SlideIn>
        <SlideIn>
          <Skills />
